    ...
    async execute(message) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setDescription([
                ...
                `Sou o **MightWard**, um bot multifuncional criado para ajudar na administração, entretenimento e segurança do seu servidor.`,
                ``,
                `${divider}`,
                ``,
                `${question} • Use \`/ajuda\` para ver todos os comandos disponíveis.`,
                `${book} • Me adicione ao seu servidor: [Clique aqui](https://mightward.abccloud.com.br/)`,
                ``,
                `${divider}`,
                ``,
                `**Links úteis:**`,
                `• [Termos de Serviço](https://mightward.abccloud.com.br/termos.html)`,
                `• [Política de Privacidade](https://mightward.abccloud.com.br/privacidade.html)`
            ].join('\n'))
            .setFooter({
                text: 'MightWard - Seu assistente de confiança!',
                iconURL: botAvatar,
            })
            .setTimestamp();
        ...
        const row = new ActionRowBuilder().addComponents(
            new ButtonBuilder()
                ...
                .setURL('https://mightward.abccloud.com.br/'),
